...
export default function FloatingWhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-30 hidden items-center gap-2 rounded-btn bg-[#1faf54] px-4 py-3.5 text-sm font-semibold text-white shadow-lift transition-transform hover:-translate-y-0.5 lg:inline-flex"
    >
