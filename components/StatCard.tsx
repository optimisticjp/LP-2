...
export default function StatCard({ value, label, sub, light = false }: Props) {
  return (
    <div
      className={`flex h-full flex-col items-center justify-center rounded-2xl border p-6 text-center sm:p-7 ${
        light
    ...
    >
      <div
        className={`font-sans text-3xl font-bold leading-none sm:text-4xl ${
