...
export const schools: School[] = [
  {
    ...
    board: 'GSEB',
    flagship: true,
    tagline: 'Where technology meets education and every child grows with confidence.',
    blurb: [
      'L. P. Savani School in Palanpor is a dynamic campus focused on shaping well-rounded individuals. Academics, character and activity beyond the classroom are held together in one nurturing, encouraging space.',
      'Modern classrooms, a well-stocked library and sports facilities support a balanced learning experience, while a multilingual environment encourages every child to pursue their own potential.',
    ],
    highlights: [
      'Strong academic foundation with a multilingual learning environment',
      'Modern classrooms, library and sports facilities',
      'Values and life skills woven through academics and activities',
      'Active online admission enquiry for 2026-27',
    ],
    whyThisCampus: [
      { title: 'Academics with care', body: 'A curriculum that keeps each child at the centre, blending classroom study with research and discovery.' },
      { title: 'Character and values', body: 'Honesty, compassion, regularity and respect are encouraged as part of everyday school life.' },
      { title: 'Technology-enabled learning', body: 'Classrooms where technology supports new and engaging ways of learning.' },
      { title: 'Parent partnership', body: 'Education treated as a shared commitment between teachers, students and parents.' },
    ],
    facilities: ['Smart classrooms', 'Library', 'Science lab', 'ICT lab', 'Sports ground', 'Art & craft', 'Music & dance', 'Dining area'],
    ...
    officialUrl: 'https://lpsavani.org/LP-Savani-School-Palanpor',
    ...
    thumb: images.branchGeneric,
    hero: images.heroPrimary,
    gallery: [images.gal1, images.facScienceLab, images.facDanceRoom2, images.facOutdoorSports, images.facArtRoom, images.gal3],
  },
  {
    slug: 'adajan',
